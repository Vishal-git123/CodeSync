...
import { searchResultItemSchema } from "shadcn/schema";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div
                        key={template.id}
                        className={`relative flex p-6 border rounded-lg cuiursor-pointer transition-all duration-300 hover:scale -[1.02]
                          ${
                            selectedTemplate === template.id
                              ? "border-[#6c63ff]  shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)]"
                              : "hover:border-[#6c63ff] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_12px_40px_rgba(108,99,255,0.23),0_2px_10px_rgba(108,99,255,0.13)]"
                          }
                          `}
